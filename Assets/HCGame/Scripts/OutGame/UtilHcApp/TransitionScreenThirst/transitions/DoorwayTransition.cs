...
namespace Prime31.TransitionKit
{
    ...
    public class DoorwayTransition : TransitionKitDelegate
    {
        ...
        public IEnumerator onScreenObscured(TransitionKit transitionKit)
        {
            ...
            if (FuncLoadingScreen != null)
            {
                LoadingScreenTransition?.Invoke();
                yield return transitionKit.StartCoroutine(transitionKit.WaitLoadUntil(FuncLoadingScreen));
            }
        ...
        public Func<bool> FuncLoadingScreen { get; set; }
        public Action LoadingScreenTransition { get; set; }
    }
}