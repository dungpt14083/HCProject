...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        [HideInInspector] public float mSnapFinishThreshold = 0.01f;
        ...
        //cmdev add
        public System.Action<LoopListView2, LoopListViewItem2> mOnEndChooseCharAction = null;
        public System.Action<LoopListView2, LoopListViewItem2> mOnSnapStartMove = null;
        public System.Action<LoopListView2> mOnSnapStopMove = null;
        ...
        */
        ...
        void UpdateCurSnapData()
        {
            ...
            if (mCurSnapData.mSnapStatus == SnapStatus.NoTargetSet)
            {
                ...
                //cmdev add
                if (mOnEndChooseCharAction != null)
                    mOnEndChooseCharAction(this, nearestItem);
                //cmdev add
            }
            if (mCurSnapData.mSnapStatus == SnapStatus.TargetHasSet)
            {
                ...
                //cmdev add
                if (mOnSnapStartMove != null)
                    mOnSnapStartMove(this, targetItem);
                //cmdev add
            }
        ...
        void UpdateSnapHorizontal(bool immediate = false, bool forceSendEvent = false)
        {
            ...
            {
                //cmdev add
                if(mOnSnapStopMove != null)
                    mOnSnapStopMove(this);
                //cmdev add
                mScrollRect.StopMovement();
            }
            float old = mCurSnapData.mCurSnapVal;
