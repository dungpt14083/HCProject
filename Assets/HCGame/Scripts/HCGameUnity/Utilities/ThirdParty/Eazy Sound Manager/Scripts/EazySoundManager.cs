...
namespace Hellmade.Sound
{
    ...
    public class EazySoundManager : MonoBehaviour
    {
        ...
        private static List<AudioSource> sceneSoundSource;
        ...
        private void Init()
        {
            if (!initialized)
            {
                ...
                sceneSoundSource = new List<AudioSource>();
        ...
        private void Update()
        {
            ...
            foreach(AudioSource source in sceneSoundSource)
            {
                if(source != null)
                {
                    source.volume = EazySoundManager.GlobalSoundsVolume * EazySoundManager.GlobalVolume;
                }
            }
        }
        ...
        public static void RegisterSceneSoundSource(AudioSource inputSource)
        {
            sceneSoundSource.Add(inputSource);
        }

        public static void UnregisterSceneSoundSource(AudioSource inputSource)
        {
            if(true == sceneSoundSource.Contains(inputSource))
            {
                sceneSoundSource.Remove(inputSource);
            }
        }
