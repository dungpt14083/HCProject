...
{
    static string bundleConfigPath = "BundleConfig";

    public static void BuildAssetBundles() {

        string outputPath = AssetBundleUtility.GetAssetBundlePath();
    ...
    public static void FindAllAssetsInBundle( string assetBundleName )
    {
        ...
        foreach( var assetPathAndName in AssetDatabase.GetAssetPathsFromAssetBundle(assetBundleName) )
        {
            ...
            string extendName = nameWithoutPath.Substring(nameWithoutPath.LastIndexOf(".") + 1);
